document.addEventListener('DOMContentLoaded', () => {
    ...
    const notesData = {
        'who-is-memo': {
            ...
            content: `
                <p>I’m the son of immigrants and grew up in a home shaped by addiction, abuse, and instability after my father was deported, leaving my mom to raise three kids alone.</p>
                <p>For a long time I drifted into my own bad habits, but eventually I stopped seeing myself as a victim and started taking responsibility for who I want to become. That’s why I’m obsessed with creating tools and systems that actually help people who feel lost or unsupported—because I know what it’s like to need help and not have it.</p>
                <br>
                <h3>Interests</h3>
...
Pharmacology has always been a big interest of mine, since I was a kid I was always intruiged on how chemicals can effect your brain, and as an adult it was amplified. I love peptides, research chemicals, and anything bio hacking related.</p>
                <br>
                <p><b>Cybersecurity</b><br>
Cybersecurity has come more recently, I like how people use their brain power to do things like look for vulnerabilites and the idea of OSINT is very interesting to me. I plan on doing more research in this field.</p>
                <br>
                <p><b>Finance</b><br>
I LOVE the stock market and the crypto market, it was a big part of my life from 2020-2022. I love reading charts and I am always looking at world events and thinking how it could effect the NYSE.</p>
                <br>
        ...
        'projects': {
            ...
            content: `
                ...
                <div class="project-card">
                    <h3>Varsity Soles</h3>
                    <p>A project I'm working on.</p>
                    <a href="https://github.com/notmemoo/varsity-soles" target="_blank" style="color: #E0AB38">View on GitHub</a>
                </div>
                <br>
                <div class="project-card">
                    <h3>Super Steve Massage</h3>
                    <p>Another project in my portfolio.</p>
                    <a href="https://github.com/notmemoo/SuperSteveMassage" target="_blank" style="color: #E0AB38">View on GitHub</a>
                </div>
            `
        },
        'future': {
